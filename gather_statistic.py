...
s += ("%.4f" % ((data['compressed_size'][1] + data['compressed_size'][2]) / (data['original_size'][1] + data['original_size'][2]))) + ","
s += ("%.4f" % (data['compressed_size'][1] / data['original_size'][1])) + ","
s += ("%.4f" % (data['compressed_size'][2] / data['original_size'][2]))
file.write(s)
file.close()